...
--   É um "depósito temporário" entre os OLTPs e o DW final.
--   Os dados chegam aqui "crus", sem limpeza ou padronização.
--   Isso isola o DW de problemas das fontes (formatos diferentes,
--   campos faltando, nomes de colunas distintos entre grupos etc.).
--
-- POR QUE PREFIXOS g1_, g2_, g3_, g4_?
--   Cada empresa tem seu próprio OLTP com estrutura diferente.
--   O prefixo evita colisão de nomes e permite rastrear a origem.
--   g1_ → nosso grupo | g2_ → gupessanha | g3_ → guilherme-hu
--   g4_ → mhscardoso
--
