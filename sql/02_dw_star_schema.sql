...
--   É o modelo dimensional padrão de DW. Uma tabela central de
--   FATOS (métricas numéricas) é cercada por tabelas de DIMENSÕES
--   (atributos descritivos). As junções são sempre Fato → Dimensão,
--   o que torna as consultas analíticas rápidas e intuitivas.
--
-- SURROGATE KEYS (sk_*):
